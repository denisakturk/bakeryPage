...
gulp.task('css-libs', ['sass'], function() {
    return gulp.src('dev/css/libs.sass') // Выбираем файл для минификации
        .pipe(sass()) // Преобразуем Sass в CSS посредством gulp-sass
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts'], function() {
    ...
    gulp.watch(['dev/js/common.js', 'dev/libs/**/*.js'], browserSync.reload);   // Наблюдение за JS файлами в папке js
});
